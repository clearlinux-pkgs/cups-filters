...
Version  : 1.28.17
Release  : 82
URL      : https://github.com/OpenPrinting/cups-filters/releases/download/1.28.17/cups-filters-1.28.17.tar.bz2
Source0  : https://github.com/OpenPrinting/cups-filters/releases/download/1.28.17/cups-filters-1.28.17.tar.bz2
...
%prep
%setup -q -n cups-filters-1.28.17
cd %{_builddir}/cups-filters-1.28.17
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a cups-filters-1.28.17 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730855147
...
# not installing the service while cups-browsed is problematic
