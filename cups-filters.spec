...
Source0  : https://www.openprinting.org/download/cups-filters/cups-filters-1.27.5.tar.bz2
...
%prep
%setup -q -n cups-filters-1.27.5
cd %{_builddir}/cups-filters-1.27.5
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1591377146
...
cp %{_builddir}/cups-filters-1.27.5/COPYING %{buildroot}/usr/share/package-licenses/cups-filters/c6b4350faf4f2afbe6e86adeccf8def01a37fff9
%make_install
