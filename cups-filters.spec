...
Version  : 1.28.1
Release  : 61
URL      : https://www.openprinting.org/download/cups-filters/cups-filters-1.28.1.tar.bz2
Source0  : https://www.openprinting.org/download/cups-filters/cups-filters-1.28.1.tar.bz2
...
%prep
%setup -q -n cups-filters-1.28.1
cd %{_builddir}/cups-filters-1.28.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1598639673
...
cp %{_builddir}/cups-filters-1.28.1/COPYING %{buildroot}/usr/share/package-licenses/cups-filters/5a5f215ed6c3222d7b07bc84da8d6d9755d65883
%make_install
