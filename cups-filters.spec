...
Source0  : https://www.openprinting.org/download/cups-filters/cups-filters-1.28.9.tar.bz2
...
%prep
%setup -q -n cups-filters-1.28.9
cd %{_builddir}/cups-filters-1.28.9
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1623791951
