...
Version  : 1.21.3
Release  : 26
URL      : https://github.com/OpenPrinting/cups-filters/releases/download/release-1-21-3/cups-filters-1.21.3.tar.bz2
Source0  : https://github.com/OpenPrinting/cups-filters/releases/download/release-1-21-3/cups-filters-1.21.3.tar.bz2
...
Requires: cups-filters-config = %{version}-%{release}
...
export LANG=C
export SOURCE_DATE_EPOCH=1538619849
