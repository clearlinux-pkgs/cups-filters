...
Source0  : https://www.openprinting.org/download/cups-filters/cups-filters-1.28.4.tar.bz2
...
%prep
%setup -q -n cups-filters-1.28.4
cd %{_builddir}/cups-filters-1.28.4
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1602173424
...
cp %{_builddir}/cups-filters-1.28.4/COPYING %{buildroot}/usr/share/package-licenses/cups-filters/5a5f215ed6c3222d7b07bc84da8d6d9755d65883
%make_install
