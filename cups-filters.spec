...
Source0  : https://www.openprinting.org/download/cups-filters/cups-filters-1.27.3.tar.bz2
...
%prep
%setup -q -n cups-filters-1.27.3
cd %{_builddir}/cups-filters-1.27.3
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1584737657
...
cp %{_builddir}/cups-filters-1.27.3/COPYING %{buildroot}/usr/share/package-licenses/cups-filters/c6b4350faf4f2afbe6e86adeccf8def01a37fff9
%make_install
